...
$conn = mysqli_connect("localhost","root","","ideatrip","3308");
  if(isset($_POST['submit'])) {
    ...
    mysqli_query($conn, "INSERT INTO twu_detail values ('','$type','$area','$dest','$start','$end','$itin','$status','$foto','$price','$min')");
    echo mysqli_query;
...
<body>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Form Trip</h5>
              ...
              <form action="#" method="POST">
               ...
               <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Plan Date</label>
                  <div class="col-sm-10">
                ...
                <fieldset class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="Non Activ">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>IdeaTrip.id</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
